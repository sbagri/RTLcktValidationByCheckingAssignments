    ...
    else
    {
        ...
        if ((4 & (IData)(vlTOPp->v__DOT__stato)))
        {
            if ((2 & (IData)(vlTOPp->v__DOT__stato)))
            {
                ...
                else
                {
                    ...
                    if ((0xf != (IData)(vlTOPp->v__DOT__mar)))
                    {
                        ...
                        {
                            __Vdly__v__DOT__cont = (0xff & ((IData)(1)+ (IData)(vlTOPp->v__DOT__cont)));
                            __Vdly__v__DOT__mar = (0xff& ((IData)(1)+ (IData)(vlTOPp->v__DOT__mar)));
                    ...
                    else
                    {
                        ...
                        if ((0 == (IData)(vlTOPp->start)))
                        {
                            ...
                            if ((2 == (IData)(vlTOPp->v__DOT__x)))
                            {
                                ...
                                vlTOPp->punti_retta = (0xff & ((IData)(1)+ (IData)(vlTOPp->v__DOT__cont)));
                                __Vdly__v__DOT__stato = 1;
                            }
                            else
                            {
                                ++(vlSymsp->__Vcoverage[13]);
                                vlTOPp->punti_retta = vlTOPp->v__DOT__cont;
                                __Vdly__v__DOT__stato = 1;
                            }
                        }
                        else
            ...
            else
            {
                if ((1 & (IData)(vlTOPp->v__DOT__stato)))
                {
                    __Vdly__v__DOT__x = (0xff & ((IData)(vlTOPp->v__DOT__x)+ (IData)(vlTOPp->v__DOT__y)));
                    ++(vlSymsp->__Vcoverage[8]);
                    __Vdly__v__DOT__stato = 6;
                }
                else
                {
                    __Vdly__v__DOT__x = (0xff & ((IData)(vlTOPp->v__DOT__x)+ (IData)(vlTOPp->v__DOT__t)));
                    ++(vlSymsp->__Vcoverage[7]);
                    __Vdly__v__DOT__y = (IData)(vlTOPp->v__DOT__mem)[(0xf & (IData)(vlTOPp->v__DOT__mar))];
        ...
        else
        {
            if ((2 & (IData)(vlTOPp->v__DOT__stato)))
            {
                if ((1 & (IData)(vlTOPp->v__DOT__stato)))
                {
                    ...
                    __Vdly__v__DOT__t = (0xff & ((IData)(vlTOPp->v__DOT__x)+ (IData)(vlTOPp->v__DOT__x)));
                    __Vdly__v__DOT__stato = 4;
                }
                else
                {
                    ++(vlSymsp->__Vcoverage[5]);
                    __Vdly__v__DOT__x = (IData)(vlTOPp->v__DOT__mem)[(0xf & (IData)(vlTOPp->v__DOT__mar))];
