...
void Vtop::__Vconfigure(Vtop__Syms* vlSymsp, bool first) {
    ...
    __vlCoverInsert(&(vlSymsp->__Vcoverage[0]), first, "b07.v", 25, 0, ".v", "v_line/b07", "if");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[1]), first, "b07.v", 60, 0, ".v", "v_line/b07", "case");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[2]), first, "b07.v", 66, 0, ".v", "v_line/b07", "if");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[3]), first, "b07.v", 73, 0, ".v", "v_line/b07", "else");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[4]), first, "b07.v", 64, 0, ".v", "v_line/b07", "case");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[5]), first, "b07.v", 78, 0, ".v", "v_line/b07", "case");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[6]), first, "b07.v", 83, 0, ".v", "v_line/b07", "case");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[7]), first, "b07.v", 89, 0, ".v", "v_line/b07", "case");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[8]), first, "b07.v", 95, 0, ".v", "v_line/b07", "case");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[9]), first, "b07.v", 104, 0, ".v", "v_line/b07", "if");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[10]), first, "b07.v", 111, 0, ".v", "v_line/b07", "else");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[11]), first, "b07.v", 102, 0, ".v", "v_line/b07", "if");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[12]), first, "b07.v", 120, 0, ".v", "v_line/b07", "if");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[13]), first, "b07.v", 126, 0, ".v", "v_line/b07", "else");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[14]), first, "b07.v", 118, 0, ".v", "v_line/b07", "if");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[15]), first, "b07.v", 132, 0, ".v", "v_line/b07", "else");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[16]), first, "b07.v", 117, 0, ".v", "v_line/b07", "else");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[17]), first, "b07.v", 100, 0, ".v", "v_line/b07", "case");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[18]), first, "b07.v", 137, 0, ".v", "v_line/b07", "case");
    __vlCoverInsert(&(vlSymsp->__Vcoverage[19]), first, "b07.v", 58, 0, ".v", "v_line/b07", "else");
}
