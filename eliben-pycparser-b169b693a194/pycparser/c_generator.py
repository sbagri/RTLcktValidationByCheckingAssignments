...
class CGenerator(object):
    ...
    def visit_UnaryOp(self, n):
        ...
        if n.op == 'p++':
            ...
            return 'Not(%s)' % self.visit(n.expr)
        else:
    ...
    def visit_BinaryOp(self, n):
        ...
        rval_str = self._parenthesize_if(n.right, 
                            lambda d: not self._is_simple_node(d))
        if n.op == "|":
            return 'Or(%s, %s)' % (lval_str, rval_str)
        elif n.op == "<":
            return 'ULT(%s, %s)' % (lval_str, rval_str)
        elif n.op == "<=":
            return 'ULE(%s, %s)' % (lval_str, rval_str)
        elif n.op == ">":
            return 'UGT(%s, %s)' % (lval_str, rval_str)
        elif n.op == ">=":
            return 'UGE(%s, %s)' % (lval_str, rval_str)
